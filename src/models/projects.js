...
const createProject = async (projectData) => {
    const { title, description, location, project_date, organization_id } = projectData;
...
export { getAllProjects, getAllProjectsByOrganizationId, getUpcomingProjects, getProjectDetails, createProject }